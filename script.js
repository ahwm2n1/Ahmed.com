...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showWelcomePopup() {
        ...
        welcomePopup.innerHTML = `
            <div class="popup-content">
                <div class="popup-header">
                    <h2>Welcome to Ahmed's Portfolio</h2>
        ...
        const textInterval = setInterval(changeText, 1000);
    ...
    function startHeaderTextChange() {
        ...
        setInterval(changeHeaderText, 1500);
    }
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const phoneNumber = '+923034676708';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initPricingCalculator() {
        ...
        document.getElementById('whatsapp-quote').addEventListener('click', function() {
            ...
            window.open(`https://wa.me/923034676708?text=${message}`, '_blank');
        });
    ...
    function initLiveChat() {
                ...
                setTimeout(() => {
                    ...
                    switch(message) {
                        ...
                        case 'I need urgent help':
                            botReply = "For urgent help, please call me directly at +92 303 4676708 or send a WhatsApp message. I'll respond within 30 minutes!";
                            break;
                        default:
        ...
        function sendMessage() {
            ...
            if (message) {
                ...
                // Auto reply
                setTimeout(() => {
                    addBotMessage("Thanks for your message! I'll get back to you soon. For immediate response, please call +92 303 4676708");
                }, 1500);
            }
        }
